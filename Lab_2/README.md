...
<a href="https://www.codecogs.com/eqnedit.php?latex=Cost&space;=&space;[10L1.D_{size}(1&plus;\frac{L1.D_{Assoc}}{10}&space;&plus;&space;\frac{L1.D_{CacheLine}}{64})&plus;10L1.I_{size}(1&plus;\frac{L1.I_{Assoc}}{10}&space;&plus;&space;\frac{L1.I_{CacheLine}}{64})&plus;L2_{size}(1&plus;\frac{L2_{Assoc}}{20}&plus;\frac{L2_{CacheLine}}{128})]*ln(\frac{CPI_{new}-CPI_{old}}{CPI_{old}}&plus;e)" target="_blank"><img src="https://latex.codecogs.com/gif.latex?Cost&space;=&space;[10L1.D_{size}(1&plus;\frac{L1.D_{Assoc}}{10}&space;&plus;&space;\frac{L1.D_{CacheLine}}{64})&plus;10L1.I_{size}(1&plus;\frac{L1.I_{Assoc}}{10}&space;&plus;&space;\frac{L1.I_{CacheLine}}{64})&plus;L2_{size}(1&plus;\frac{L2_{Assoc}}{20}&plus;\frac{L2_{CacheLine}}{128})]*ln(\frac{CPI_{new}-CPI_{old}}{CPI_{old}}&plus;e)" title="Cost = [10L1.D_{size}(1+\frac{L1.D_{Assoc}}{10} + \frac{L1.D_{CacheLine}}{64})+10L1.I_{size}(1+\frac{L1.I_{Assoc}}{10} + \frac{L1.I_{CacheLine}}{64})+L2_{size}(1+\frac{L2_{Assoc}}{20}+\frac{L2_{CacheLine}}{128})]*ln(\frac{CPI_{new}-CPI_{old}}{CPI_{old}}+e)" /></a>
